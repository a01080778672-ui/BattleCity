...
{
    public CardContext(CardInstance usedCard, GameState fsmState, GameLoopData gameLoopData, EntityInstance usedEntity, EntityInstance targetEntity, List<GameLoopData.BattleLog> logs=null)
    {
        this.usedCard = usedCard;
        this.fsmState = fsmState;
        this.gameLoopData = gameLoopData;
    ...
    public List<GameLoopData.BattleLog> logs=new List<GameLoopData.BattleLog>();//배틀로그(비어있을수도)
