 ...
 
{
    ...
    [SerializeField] private List<RectTransform> enemyBlockCardZones;//적가드존


    [SerializeField] private List<RectTransform> playerBlockCardZones;//플레이어가드존
    ...
    [SerializeField] private TextMeshProUGUI logText;//로그텍스트
